from vc.OCR import OCR
from vc.PhoneControl import PhoneControl
import numpy as np


class VC(PhoneControl, OCR):
    """
    根据给定的文字或位置信息执行屏幕点击动作
    """
...
if __name__ == '__main__':
    from weixin_operate.config import BTN
    vc = VC('127.0.0.1:62025')
    vc.click_by_loc(BTN['EMU_WEIXIN_ICON'])
    vc.get_screen_cap()
    # vc.click_by_words('Duai')
